...
//" . $id. "," . $nom. "," .$apel. "," .$gen. "," .$tel . "
   public function GuardarRegistro($tabla,$Campos,$Parametros,$Valores){
     $this->Conectar();
...
// Toca cambiar este metodo
   ...
   public function TraeRegistro($Campo,$Tabla,$Llave, $Valor){
     $this->Conectar();
   ...
   public function TraePrueba($SQL){
    $this->Conectar();
    $Sentencia = $this->Conexion->prepare($SQL);
    $Sentencia->execute();
    return $Sentencia->fetchAll();
